...
KIND_CLUSTER ?= shadowcast-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name shadowcast-builder
	$(CONTAINER_TOOL) buildx use shadowcast-builder
	...
	- $(CONTAINER_TOOL) buildx rm shadowcast-builder
	rm Dockerfile.cross
