...
var _ = Describe("ShadowPolicy Controller", func() {
	Context("When reconciling a resource", func() {
		...
		shadowpolicy := &trafficv1alpha1.ShadowPolicy{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind ShadowPolicy")
			err := k8sClient.Get(ctx, typeNamespacedName, shadowpolicy)
